...
public class MemoryRepository implements BookingRepository, RoomRepository {
    ...
    public MemoryRepository() {
        ...
        this.rooms.add(new Room("L001", new LinkedList<>()));
        this.rooms.add(new Room("L002", new LinkedList<>()));
        this.rooms.add(new Room("L003", new LinkedList<>()));
        this.rooms.add(new Room("L004", new LinkedList<>()));
        this.rooms.add(new Room("L005", new LinkedList<>()));
